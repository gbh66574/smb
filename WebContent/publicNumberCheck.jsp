...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#dg").datagrid({
			idField:"id",
			url:"PublicNumberCheck/queryAll",
		...
		$("#export_btn").click(function(){
			$.messager.confirm("确定信息","确定要下载PublicNumberCheck.xls文件吗？",function(r){
				if(r){
					location.href="PublicNumberCheckServlet?opType=downloadxls&fileName=PublicNumberCheck.xls"
				}
			});
		});
