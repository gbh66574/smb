...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#export_btn").click(function(){
			$.messager.confirm("确定信息","确定要下载publicNumberTemplate.xls文件吗？",function(r){
				if(r){
					location.href="publicNumberTemplateServlet?opType=downloadxls&fileName=publicNumberTemplate.xls"
				}
			});
		}); */
