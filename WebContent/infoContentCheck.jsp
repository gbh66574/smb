	...
	$(function(){
		...
		$("#dg").datagrid({
			...
			columns:[[
				...
				{field:"content",title:"信息内容",width:100,align:"center"},
				{field:"user_id",title:"申请人编号",width:100,align:"center"},
		...
		$("#export_btn").click(function(){
			$.messager.confirm("确定信息","确定要下载InfoContentCheck.xls文件吗？",function(r){
				if(r){
					location.href="InfoContentCheckServlet?opType=downloadxls&fileName=InfoContentCheck.xls"
				}
			});
		});
...
<body>
	<div style="height: 5%">
		...
		<form name="searchform" method="post" id ="searchform">
			公众号编号：<input type="text" name="qpid" class="easyui-textbox" >
		...
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				...
				<tr>
					...
					<td><input type="text" name="pid" class="easyui-numberbox" data-options="required:true"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="user_id" class="easyui-numberbox" data-options="required:true"></td>
				</tr>
				
				<tr>
					<td class="right">提交时间：</td>
					<td><input type="text" name="applyTime" class="easyui-datebox" data-options="required:true"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="checkedTime" class="easyui-datebox" data-options="required:true"></td>
				</tr>
