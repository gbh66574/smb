	...
	$(function(){
		...
		$("#dg").datagrid({
			...
			columns:[[
				...
				{field:"tid",title:"内容模板",width:100,align:"center"},
		...
		$("#export_btn").click(function(){
			$.messager.confirm("确定信息","确定要下载InfoContent.xls文件吗？",function(r){
				if(r){
					location.href="InfoContentServlet?opType=downloadxls&fileName=InfoContent.xls"
				}
			});
		});
...
<body>
	<div style="height: 5%">
		...
		<form name="searchform" method="post" id ="searchform">
			账号：<input type="text" name="qInfoContentname" class="easyui-textbox" >
