	...
	$(function(){
		...
		$("#dg").datagrid({
			...
			columns:[[
				...
				{field:"username",title:"用户编号",width:100,align:"center"}
		...
		$("#export_btn").click(function(){
			$.messager.confirm("确定信息","确定要下载UserPublicNumber.xls文件吗？",function(r){
				if(r){
					location.href="UserPublicNumberServlet?opType=downloadxls&fileName=UserPublicNumber.xls"
				}
			});
		});
...
<body>
	<div style="height: 5%">
		...
		<form name="searchform" method="post" id ="searchform">
			用户编号：<input type="text" name="quser_id" class="easyui-textbox" >
