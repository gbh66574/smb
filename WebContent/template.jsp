	...
	$(function(){
		...
		$("#dg").datagrid({
			...
			columns:[[
				...
				{field:"user_id",title:"创建人id",width:100,align:"center"}
			]],
			fitColumns:true,
			toolbar: [{
				text:"新增",
		...
		$("#export_btn").click(function(){
			$.messager.confirm("确定信息","确定要下载Template.xls文件吗？",function(r){
				if(r){
					location.href="TemplateServlet?opType=downloadxls&fileName=Template.xls"
				}
			});
		});
...
<body>
	<div style="height: 5%">
		...
		<form name="searchform" method="post" id ="searchform">
			账号：<input type="text" name="qTemplatename" class="easyui-textbox" >
